...
| **Screen 4: Modding** | Nav Bar (Top) | Back, Undo/Redo, Preview, APPLY | Mũi tên Undo/Redo sắc nét. Nút APPLY luôn dẫn tới 1 lượt Reward Ads. | Bấm Back ➔ Gọi Modal Unsaved. Bấm Apply ➔ **LUÔN** gọi Modal Video Ads (kể cả phôi Free) ➔ xem xong mới Set Wallpaper. |
